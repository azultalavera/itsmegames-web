...
function App() {
  return (
    <div className="min-h-screen relative bg-darkbg">
      ...
      <div className="absolute inset-0 bg-[url('/grid.svg')] bg-center [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0))]" style={{ opacity: 0.05, pointerEvents: 'none', backgroundSize: '30px 30px' }}></div>
