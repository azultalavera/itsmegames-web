    ...
    <section className="relative w-full py-32 overflow-hidden bg-darkbg border-y border-neon/20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="text-center mb-12">
            ...
            >
              <motion.h2
                ...
                className="text-5xl sm:text-6xl md:text-8xl font-Orbitron font-bold uppercase text-white cursor-pointer relative inline-block"
              >
                <span className="relative z-10 text-glow transition-all duration-300 group-hover:text-neon">
                  LAYER 8: ERROR
                </span>
              ...
              <div className="mt-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <span className="text-neon font-mono text-xs tracking-[0.3em] uppercase">Click to Access System</span>
              </div>
            </a>
          </div>
          ...
          >
            <div className={`font-['Consolas',_'monospace'] text-left text-base sm:text-lg md:text-xl leading-relaxed space-y-6 transition-all duration-500 ${isTextHovered ? 'text-gray-200 blur-0' : 'text-gray-500 blur-[3px]'
              }`}>
