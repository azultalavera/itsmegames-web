  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4 relative overflow-hidden font-inter text-white">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(\"data:image/svg+xml,%3Csvg width='100' height='100' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noiseFilter'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.9' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noiseFilter)'/%3E%3C/svg%3E\")",
        }}
      ></div>
      ...
      <div className="max-w-2xl w-full text-center relative z-10">
        ...
        <h1 className="text-8xl md:text-9xl font-orbitron font-black text-transparent bg-clip-text bg-gradient-to-b from-white to-gray-600 mb-4 relative inline-block">
          404
          <span
            className="absolute top-0 left-1 text-red-500 opacity-50 mix-blend-screen animate-pulse"
            style={{ clipPath: 'polygon(0 0, 100% 0, 100% 30%, 0 30%)' }}
          >
            404
          </span>
          <span
            className="absolute top-0 -left-1 text-neon opacity-50 mix-blend-screen animate-pulse"
